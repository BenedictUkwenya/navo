      ...
      <nav className="sidebar-nav">
        <ul>
          ...
          <li className={getNavItemClass("/shipments")}>
            <Link to="/shipments" onClick={handleLinkClick}>
              <img src={shipmentIcon} alt="" /> Shipments
            </Link>
          </li>
          <li className={getNavItemClass("/quote-request")}>
            <Link to="/quote-request" onClick={handleLinkClick}>
              <img src={quoteIcon} alt="" /> Quote Request
            </Link>
          </li>
          <li className={getNavItemClass("/tracking")}>
            <Link to="/tracking" onClick={handleLinkClick}>
              <img src={trackingIcon} alt="" /> Tracking Mgt.
            </Link>
          </li>
          <li className={getNavItemClass("/purchase-orders")}>
            <Link to="/purchase-orders" onClick={handleLinkClick}>
              <img src={purchaseOrdersIcon} alt="" /> Purchase Orders
            </Link>
          </li>
          <li className={getNavItemClass("/fx")}>
            <Link to="/fx" onClick={handleLinkClick}>
          ...
          <li className={getNavItemClass("/support")}>
            <Link to="/support" onClick={handleLinkClick}>
              <img src={supportTicketIcon} alt="" /> Support Ticket
            </Link>
          </li>
          <li className={getNavItemClass("/exchange-rate")}>
            <Link to="/exchange-rate" onClick={handleLinkClick}>
              <img src={transactionIcon} alt="" /> Exchange Rate
            </Link>
          </li>
        </ul>
