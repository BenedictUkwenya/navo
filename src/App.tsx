      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route
            path="/quote-request"
            element={
              <Layout pageTitle="Quote Request">
                <QuoteRequestPage />
              </Layout>
            }
          />
          <Route
            path="/tracking"
            element={
              <Layout pageTitle="Tracking Management">
                <TrackingMgtPage />
              </Layout>
            }
          />
          ...
          <Route
            ...
            element={
              <Layout pageTitle="Order for Purchase">
                <PurchaseOrdersPage />
              </Layout>
            }
          />
          ...
          <Route
            path="/support"
            element={
              <Layout pageTitle="Support Ticket">
                <SupportTicketPage />
              </Layout>
            }
          />
          <Route
            path="/audit"
            element={
              <Layout pageTitle="Audit Management">
                <AuditMgtPage />
              </Layout>
            }
          />
          ...
          <Route
            ...
            element={
              <Layout pageTitle="Shipment Details">
                <ShipmentDetailsPage />
              </Layout>
            }
          />
